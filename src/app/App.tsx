...
const timeline = [
  {
    ...
    desc: "Working on robotics research and embedded systems development. Contributing to autonomous mobile robots using ROS2, Raspberry Pi, ESP32, LiDAR, and computer vision while developing and testing real-world robotic solutions.",
    tags: [
      "ROS2",
      "Python",
      "C++",
  ...
  },
  {
    ...
    location: "Kathmandu, Nepal",
    desc: "Built responsive web interfaces using React and Next.js, integrated REST APIs, collaborated with designers to implement modern UI/UX, and optimized application performance for a better user experience.",
    tags: [
      "React",
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    role: "B.Sc. (Hons) Computing",
    location: "Kathmandu, Nepal",
    desc: "Pursuing a Bachelor's degree in Computing with coursework in software engineering, machine learning, cloud computing, distributed systems, and robotics. Completed multiple full-stack, AI, and embedded systems projects.",
    tags: [
